package com.smgvalen.library.controllers;

import com.smgvalen.library.models.Book;
...
public class BookController {
  ...
  @RequestMapping(path = "/getBooks", method = RequestMethod.GET)  //http://localhost:8080/getBooks/?author=Kurt%20Vonnegut
  public String showBooks(Model model,
